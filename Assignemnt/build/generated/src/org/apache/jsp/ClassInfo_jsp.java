...
public final class ClassInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  ArrayList<Information> in = (ArrayList<Information>) session.getAttribute("in3"); 
      ...
      out.write("        \n");
      out.write("        <main>\n");
      out.write("            <h1>List student in Class: ");
      out.print(classname);
      out.write("</h1>\n");
      out.write("            ");
if(!in.isEmpty()){
  ...
  for (Information inf : in) {
      ...
      out.write("            <tr>\n");
      out.write("                <td>");
      out.print(inf.getCount());
      out.write("</td>\n");
      out.write("                <td><a href=\"memberinclass?n=");
      out.print(inf.getEmail());
      out.write('"');
      out.write('>');
      out.print(inf.getStudentnumber());
      out.write("</a></td>\n");
      out.write("                <td>");
      out.print(inf.getName());
      out.write("</td>\n");
      out.write("                <td>");
      out.print(inf.getRollnumber());
      out.write("</td>\n");
      out.write("            </tr>\n");
      out.write("            ");
}
      ...
      out.write("\n");
      out.write("            <h4>The List is emty</h4>\n");
      out.write("             ");
}
      out.write("\n");
      out.write("        </main>\n");
